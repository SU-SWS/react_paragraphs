 ...
 *   revision_table = "paragraphs_row_revision",
 *   revision_data_table = "paragraphs_row_field_revision",
 *   translatable = TRUE,
 ...
 * )
 */
class ParagraphsRow extends EditorialContentEntityBase implements ParagraphsRowInterface {
  ...
  public function preSave(EntityStorageInterface $storage) {
    ...
    // make the paragraphs_row owner the revision author.
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('The user ID of author of the Paragraphs Row entity.'))
